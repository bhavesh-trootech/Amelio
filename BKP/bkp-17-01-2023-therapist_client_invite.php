...
<div class="clientListMain">
 ...
 <?php
      ...
      $resultRows = $wpdb->get_results( "SELECT * FROM $invitedusersTable");
   ...
   $inviteMethod = $rowdata->inviteMethod;
   ...
   ?>
  <tr data-id="<?php echo $invitedusersid; ?>" data-status="<?php echo $status; ?>">
    <td class="tabletd clientName"><?php echo $nameClient; ?></td>
    <td class="tabletd clientEmail"><?php echo $invitationEmailId; ?></td>
    <td class="tabletd clientMethod"><?php echo $inviteMethod; ?></td>
    <td class="tabletd clientSignUp"><?php echo $status; ?></td>
    <td class="tabletd clientdate"><?php echo $dateNum." ".$monthName." ".$yearNum; ?></td>
    <td class="tabletd clientaction"><span class="threedotsDropdown">Action</span><ul class="actionList">
        <?php if($status != "active client"): ?>
        <li id="resentInvitation" data-clientEmail="<?php echo $invitationEmailId; ?>" data-therapistUserId="<?php echo $therapistUserId; ?>">Resent Invitation</li>
    <?php endif; ?>
        <li id="deleteClient" data-clientEmail="<?php echo $invitationEmailId; ?>" data-therapistUserId="<?php echo $therapistUserId; ?>">Delete</li>
    </ul></td>
  </tr>
  <?php } ?>
  </tbody>
